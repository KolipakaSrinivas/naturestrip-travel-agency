...
function Footer() {
  return (
    <footer className="mt-auto w-full px-4 sm:px-6 lg:px-14 py-3">
      <div className=" flex justify-between border-t-[1px] border-gray-600 py-5">
        <Link
      ...
      <div className="flex justify-between flex-col md:flex-row">
        ...
        ">
          <div className="flex items-center gap-2">
            <img src="/8324266_ui_essential_app_location_map_icon.svg" className="h-5 w-5" alt="" />
            <p style={{fontFamily:"DM Sans"}} className="text-gray-600 text-sm">Lorem ipsum, dolor sit amet consectetur .</p>
          </div>
           <div className="flex items-center gap-2">
            <img src="/4202011_email_gmail_mail_logo_social_icon.svg" className="h-5 w-5" alt="" />
            <Link href={"#"} style={{fontFamily:"DM Sans"}} className="text-gray-600 text-sm">naturestrip@gmail.com</Link>
          </div>
        </div>
        <div className="flex gap-[2rem] items-baseline justify-baseline">
        ...
        <div className="sm:flex sm:justify-between sm:items-center">
          <div className="flex flex-wrap items-center gap-3" >
            <div className="space-x-4 text-sm">
              <Link
                className="inline-flex gap-x-2 text-gray-700 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 "
                href="#"
              >
                terms & Conditions
              </Link>
          ...
          <p className="mt-3 text-xs sm:text-sm text-gray-800">
            © 2025 Naturestrip
          </p>
          ...
          <div className="flex flex-wrap justify-between items-end gap-3">
            ...
            <Link
              href="https://dsquaremarketing.com/"
              className="underline text-blue-600 hover:text-blue-400 "
              style={{ fontFamily: "Poppins" }}
            >
              Powered by: dsquaremarketing{" "}
            </Link>
          </div>
          {/* End Col */}
        </div>
